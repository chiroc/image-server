 ...
 * Module dependencies.
 * 
 * @see https://github.com/MarshalW/BackBoneDemo/blob/v0.7/app.js
 */

var express = require('express');
var routes = require('./routes');
var ItemProvider = require('./modules/ItemProvider').ItemProvider;
var ImageFileProvider = require('./modules/ImageFileProvider.js').ImageFileProvider;
